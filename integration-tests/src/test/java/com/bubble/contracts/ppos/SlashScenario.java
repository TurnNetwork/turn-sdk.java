...
import com.bubble.contracts.ppos.dto.BaseResponse;
...
public class SlashScenario extends Scenario {
	...
	public void executeScenario() throws Exception {
		...
		BigInteger slashBalance = web3j.bubbleGetBalance(slashCredentials.getAddress(), DefaultBlockParameterName.LATEST).send().getBalance();
