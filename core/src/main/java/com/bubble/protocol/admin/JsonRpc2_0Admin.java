...
public class JsonRpc2_0Admin extends JsonRpc2_0Web3j implements Admin {
    ...
    @Override
    public Request<?, BubbleSignTransaction> personalSignTransaction(Transaction transaction, String password) {
        return new Request<>(
    ...
    @Override
    public Request<?, BubbleSendTransaction> personalSendTransaction(
