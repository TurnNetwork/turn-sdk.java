 ...
 */
public class BubbleSyncing extends Response<BubbleSyncing.Result> {

    @Override
    @JsonDeserialize(using = BubbleSyncing.ResponseDeserialiser.class)
    public void setResult(BubbleSyncing.Result result) {
