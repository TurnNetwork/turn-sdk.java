...
import com.bubble.utils.NodeIdTool;
 ...
 */
public class BubbleBlock extends Response<BubbleBlock.Block> {

    @Override
    @JsonDeserialize(using = BubbleBlock.ResponseDeserialiser.class)
