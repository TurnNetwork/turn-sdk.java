package com.bubble.protocol.core.methods.response.bean;
...
public class EconomicConfig {
    ...
    public class Reward {
         ...
         */
        private BigInteger bubbleFoundationYear;
        ...
        public BigInteger getBubbleFoundationYear() {
            return bubbleFoundationYear;
        }

        public void setBubbleFoundationYear(BigInteger bubbleFoundationYear) {
            this.bubbleFoundationYear = bubbleFoundationYear;
        }
        ...
        public String toString() {
            return "Reward{" +
                    ...
                    ", bubbleFoundationYear=" + bubbleFoundationYear +
                    '}';
        }
    }
    ...
    public class InnerAcc {
         ...
         * 基金会账号地址
         */
        private String bubbleFundAccount;
        /**
         * 基金会初始金额
         */
        private BigInteger bubbleFundBalance;
        /**
         * 社区开发者账户
         */
        ...
        public String getBubbleFundAccount() {
            return bubbleFundAccount;
        }

        public void setBubbleFundAccount(String bubbleFundAccount) {
            this.bubbleFundAccount = bubbleFundAccount;
        }

        public BigInteger getBubbleFundBalance() {
            return bubbleFundBalance;
        }

        public void setBubbleFundBalance(BigInteger bubbleFundBalance) {
            this.bubbleFundBalance = bubbleFundBalance;
        }
        ...
        public String toString() {
            return "InnerAcc{" +
                    "bubbleFundAccount='" + bubbleFundAccount + '\'' +
                    ", bubbleFundBalance=" + bubbleFundBalance +
