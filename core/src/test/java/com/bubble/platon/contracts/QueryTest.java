//package org.web3j.bubble.contracts;
//
...
//        BigInteger balance = web3j.bubbleGetBalance(walletAddr, DefaultBlockParameterName.LATEST).send().getBalance();
...
//        while (true){
//            BigInteger number = web3j.bubbleGetBlockByNumber(DefaultBlockParameterName.LATEST,true).send().getBlock().getNumber();
...
//                .bubbleGetTransactionReceipt("0x06f324c40e82fe70dd4573a0fcb744998bc45cb6550ba7bec966e1778dadd376")
