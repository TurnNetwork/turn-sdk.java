...
public class SolEvent extends Contract {
    ...
    public Observable<FundTransferEventResponse> fundTransferEventObservable(BubbleFilter filter) {
        return web3j.bubbleLogObservable(filter).map(new Func1<Log, FundTransferEventResponse>() {
            @Override
    ...
    public Observable<SetNameEventEventResponse> setNameEventEventObservable(BubbleFilter filter) {
        return web3j.bubbleLogObservable(filter).map(new Func1<Log, SetNameEventEventResponse>() {
            @Override
