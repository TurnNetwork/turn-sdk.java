...
import com.bubble.protocol.ResponseTester;
...
public class ResponseTest extends ResponseTester {
    ...
    public void testErrorResponse() {
        ...
        BubbleBlock ethBlock = deserialiseResponse(BubbleBlock.class);
    ...
    public void testEthProtocolVersion() throws IOException {
        ...
        BubbleProtocolVersion ethProtocolVersion = deserialiseResponse(BubbleProtocolVersion.class);
    ...
    public void testEthSyncingInProgress() {
        ...
        BubbleSyncing ethSyncing = deserialiseResponse(BubbleSyncing.class);

        assertThat(ethSyncing.getResult(),
                equalTo(new BubbleSyncing.Syncing("0x384", "0x386", "0x454", null, null)));
    }
    ...
    public void testEthGasPrice() {
        ...
        BubbleGasPrice ethGasPrice = deserialiseResponse(BubbleGasPrice.class);
    ...
    public void testEthAccounts() {
        ...
        BubbleAccounts ethAccounts = deserialiseResponse(BubbleAccounts.class);
    ...
    public void testEthBlockNumber() {
        ...
        BubbleBlockNumber ethBlockNumber = deserialiseResponse(BubbleBlockNumber.class);
    ...
    public void testEthGetBalance() {
        ...
        BubbleGetBalance ethGetBalance = deserialiseResponse(BubbleGetBalance.class);
    ...
    public void testEthStorageAt() {
        ...
        BubbleGetStorageAt ethGetStorageAt = deserialiseResponse(BubbleGetStorageAt.class);
    ...
    public void testEthGetTransactionCount() {
        ...
        BubbleGetTransactionCount ethGetTransactionCount =
                deserialiseResponse((BubbleGetTransactionCount.class));
    ...
    public void testEthGetBlockTransactionCountByHash() {
        ...
        BubbleGetBlockTransactionCountByHash ethGetBlockTransactionCountByHash =
                deserialiseResponse(BubbleGetBlockTransactionCountByHash.class);
    ...
    public void testEthGetBlockTransactionCountByNumber() {
        ...
        BubbleGetBlockTransactionCountByNumber ethGetBlockTransactionCountByNumber =
                deserialiseResponse(BubbleGetBlockTransactionCountByNumber.class);
    ...
    public void testGetCode() {
        ...
        BubbleGetCode ethGetCode = deserialiseResponse(BubbleGetCode.class);
    ...
    public void testEthSign() {
        ...
        BubbleSign ethSign = deserialiseResponse(BubbleSign.class);
    ...
    public void testEthSendTransaction() {
        ...
        BubbleSendTransaction ethSendTransaction = deserialiseResponse(BubbleSendTransaction.class);
    ...
    public void testEthSendRawTransaction() {
        ...
        BubbleSendRawTransaction ethSendRawTransaction =
                deserialiseResponse(BubbleSendRawTransaction.class);
    ...
    public void testEthCall() {
        ...
        BubbleCall ethCall = deserialiseResponse(BubbleCall.class);
    ...
    public void testEthEstimateGas() {
        ...
        BubbleEstimateGas ethEstimateGas = deserialiseResponse(BubbleEstimateGas.class);
    ...
    public void testEthBlockTransactionHashes() {
        ...
        BubbleBlock.Block block = new BubbleBlock.Block(
                ...
                "0x54e34e8e",
                Arrays.asList(
                        new BubbleBlock.TransactionHash(
    ...
    public void testEthBlockFullTransactionsParity() {
        ...
        BubbleBlock.Block block = new BubbleBlock.Block(
                ...
                "0x54e34e8e",
                //CHECKSTYLE:OFF
                Arrays.asList(new BubbleBlock.TransactionObject(
    ...
    public void testEthTransaction() {
        ...
        BubbleTransaction ethTransaction = deserialiseResponse(BubbleTransaction.class);
    ...
    public void testeEthGetTransactionReceiptBeforeByzantium() {
        ...
        BubbleGetTransactionReceipt ethGetTransactionReceipt = deserialiseResponse(
    ...
    public void testEthFilter() {
        ...
        BubbleFilter ethFilter = deserialiseResponse(BubbleFilter.class);
    ...
    public void testEthUninstallFilter() {
        ...
        BubbleUninstallFilter ethUninstallFilter = deserialiseResponse(BubbleUninstallFilter.class);
    ...
    public void testEthLog() {
        ...
        BubbleLog ethLog = deserialiseResponse(BubbleLog.class);
