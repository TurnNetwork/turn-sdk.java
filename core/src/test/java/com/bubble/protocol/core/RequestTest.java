...
public class RequestTest extends RequestTester {
    ...
    public void testEthProtocolVersion() throws Exception {
        ...
        verifyResult(
                "{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_protocolVersion\",\"params\":[],\"id\":1}");
    }
    ...
    public void testEthSyncing() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_syncing\",\"params\":[],\"id\":1}");
    }
    ...
    public void testEthGasPrice() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_gasPrice\",\"params\":[],\"id\":1}");
    }
    ...
    public void testEthAccounts() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_accounts\",\"params\":[],\"id\":1}");
    }

    @Test
    public void testEthBlockNumber() throws Exception {
        web3j.bubbleBlockNumber().send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_blockNumber\",\"params\":[],\"id\":1}");
    }
    ...
    public void testEthGetBalance() throws Exception {
        ...
        verifyResult(
                "{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getBalance\","
    ...
    public void testEthGetStorageAt() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getStorageAt\","
    ...
    public void testEthGetTransactionCount() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getTransactionCount\","
                + "\"params\":[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\",\"latest\"],"
                + "\"id\":1}");
    }
    ...
    public void testEthGetBlockTransactionCountByHash() throws Exception {
        ...
        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getBlockTransactionCountByHash\",\"params\":[\"0xb903239f8543d04b5dc1ba6579132b143087c68db1b2168786408fcbce568238\"],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testEthGetBlockTransactionCountByNumber() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getBlockTransactionCountByNumber\","
                + "\"params\":[\"0xe8\"],\"id\":1}");
    }
    ...
    public void testEthGetCode() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getCode\","
    ...
    public void testEthSign() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_sign\","
    ...
    public void testEthSendTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_sendTransaction\",\"params\":[{\"from\":\"0xb60e8dd61c5d32be8058bb8eb970870f07233155\",\"to\":\"0xb60e8dd61c5d32be8058bb8eb970870f07233155\",\"gas\":\"0x76c0\",\"gasPrice\":\"0x9184e72a000\",\"value\":\"0x9184e72a\",\"data\":\"0xd46e8dd67c5d32be8d46e8dd67c5d32be8058bb8eb970870f072445675058bb8eb970870f072445675\",\"nonce\":\"0x1\"}],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testEthSendRawTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_sendRawTransaction\",\"params\":[\"0xd46e8dd67c5d32be8d46e8dd67c5d32be8058bb8eb970870f072445675058bb8eb970870f072445675\"],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testEthCall() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_call\","
    ...
    public void testEthEstimateGas() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_estimateGas\","
                + "\"params\":[{\"from\":\"0xa70e8dd61c5d32be8058bb8eb970870f07233155\","
    ...
    public void testEthGetBlockByHash() throws Exception {
        ...
        verifyResult(
                "{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getBlockByHash\",\"params\":["
    ...
    public void testEthGetBlockByNumber() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getBlockByNumber\","
    ...
    public void testEthGetTransactionByHash() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getTransactionByHash\",\"params\":["
    ...
    public void testEthGetTransactionByBlockHashAndIndex() throws Exception {
        ...
        //CHECKSTYLE:OFF
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getTransactionByBlockHashAndIndex\",\"params\":[\"0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331\",\"0x0\"],\"id\":1}");
        //CHECKSTYLE:ON
    }
    ...
    public void testEthGetTransactionByBlockNumberAndIndex() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getTransactionByBlockNumberAndIndex\","
    ...
    public void testEthGetTransactionReceipt() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getTransactionReceipt\",\"params\":["
                + "\"0xb903239f8543d04b5dc1ba6579132b143087c68db1b2168786408fcbce568238\"],"
                + "\"id\":1}");
    }
    ...
    public void testEthNewFilter() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_newFilter\","
    ...
    public void testEthNewBlockFilter() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_newBlockFilter\","
                + "\"params\":[],\"id\":1}");
    }
    ...
    public void testEthNewPendingTransactionFilter() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_newPendingTransactionFilter\","
                + "\"params\":[],\"id\":1}");
    }
    ...
    public void testEthUninstallFilter() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_uninstallFilter\","
                + "\"params\":[\"0x0b\"],\"id\":1}");
    }
    ...
    public void testEthGetFilterChanges() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getFilterChanges\","
                + "\"params\":[\"0x16\"],\"id\":1}");
    }
    ...
    public void testEthGetFilterLogs() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getFilterLogs\","
                + "\"params\":[\"0x16\"],\"id\":1}");
    }
    ...
    public void testEthGetLogs() throws Exception {
        ...
        verifyResult("{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getLogs\","
                + "\"params\":[{\"topics\":["
                + "\"0x000000000000000000000000a94f5374fce5edbc8e2a8697c15331677e6ebf0b\"]}],"
                + "\"id\":1}");
    }
    ...
    public void testEthGetLogsWithNumericBlockRange() throws Exception {
        ...
        verifyResult(
                "{\"jsonrpc\":\"2.0\",\"bech32\":true,\"method\":\"bubble_getLogs\","
