...
import com.bubble.abi.solidity.datatypes.Array;
 ...
 */
public abstract class TypeReference<T extends com.bubble.abi.solidity.datatypes.Type>
    ...
    public static <T extends com.bubble.abi.solidity.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends com.bubble.abi.solidity.datatypes.Type>
