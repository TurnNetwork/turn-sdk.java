...
public class NetworkParameters {
    ...
    private static String bubbleNetworkKey = ReservedChainId.Bubble.getChainId() + ":" + ReservedHrp.Bubble.getHrp();
    ...
    static {
        ...
        NetworkParameters bubble = new NetworkParameters(ReservedChainId.Bubble.getChainId(), ReservedHrp.Bubble.getHrp());
     ...
     * @param hrp   hrp, , it cannot be same as the Alaya or Bubble network's hrp.
     */
    public static void init(long chainId, String hrp){
        ...
        if (chainId==ReservedChainId.Bubble.getChainId() && !ReservedHrp.Bubble.getHrp().equals(hrp)){
            throw new RuntimeException("hrp not match to chainID");
        }
