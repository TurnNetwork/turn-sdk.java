...
import static com.bubble.crypto.SampleKeys.*;
import static com.bubble.crypto.WalletUtils.isValidAddress;
import static com.bubble.crypto.WalletUtils.isValidPrivateKey;
...
public class WalletUtilsTest {
    ...
    @Test
    public void testGenerateBubbleWalletFileByKeyPair() throws Exception {
        String fileName = WalletUtils.generateBubbleWalletFile(PASSWORD,KEY_PAIR,tempDir);
        System.out.println("fileName:" + tempDir.getAbsolutePath() + "\\" +fileName);
        testGeneratedNewWalletFile(fileName);
    }

    @Test
    public void testGenerateBubbleWalletFile() throws Exception {
    ...
    @Test
    public void testGenerateBubbleBip39Wallet() throws Exception {
        Bip39Wallet wallet = WalletUtils.generateBubbleBip39Wallet(PASSWORD, tempDir);
