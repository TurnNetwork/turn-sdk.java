...
import static com.bubble.crypto.Hash.sha256;
import static com.bubble.crypto.Keys.ADDRESS_LENGTH_IN_HEX;
import static com.bubble.crypto.Keys.PRIVATE_KEY_LENGTH_IN_HEX;
...
public class WalletUtils {
    ...
    /**
     * create a bubble standard wallet
     *
     * @param password pwd
     ...
     */
    public static String generateBubbleWalletFile(String password, File destinationDirectory)
            throws NoSuchAlgorithmException, NoSuchProviderException,
            InvalidAlgorithmParameterException, CipherException, IOException {
        ECKeyPair ecKeyPair = Keys.createEcKeyPair();

        String fileName  = generateBubbleWalletFile(password, ecKeyPair, destinationDirectory);
        return fileName;
    }

    /**
     * create a bubble standard Bip39 wallet
     *
     * @param password
     ...
     * @throws IOException
     */
    public static Bip39Wallet generateBubbleBip39Wallet(String password, File destinationDirectory)
    ...
    /**
     * Create bubble standard wallet with ecKeyPair
     *
     * @param password
     * @param ecKeyPair
     * @param destinationDirectory
     ...
     * @throws IOException
     */
    public static String generateBubbleWalletFile(String password, ECKeyPair ecKeyPair, File destinationDirectory)
            throws CipherException, IOException {

        WalletFile walletFile = Wallet.createBubble(password,ecKeyPair);
