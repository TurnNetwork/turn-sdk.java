...
import com.bubble.abi.wasm.datatypes.generated.WasmAbiTypes;
...
import com.bubble.protocol.core.methods.response.WasmAbiDefinition;
import com.bubble.protocol.core.methods.response.WasmAbiDefinition.NamedType;
...
import com.bubble.utils.Collection;
import com.bubble.utils.Strings;
import com.bubble.utils.Version;
...
public class WasmFunctionWrapper extends Generator {
	...
	private static final String CODEGEN_WARNING = "<p>Auto generated code.\n" + "<p><strong>Do not modify!</strong>\n" + "<p>Please use the "
			+ "<a href=\"https://github.com/Bubblenetwork/client-sdk-java/releases\">bubble-web3j command line tools</a>,\n" + "or the "
	...
	private String getWeb3jVersion() {
		...
		return "\n<p>Generated with bubble-web3j version " + version + ".\n";
	}
	...
	MethodSpec buildEventObservableFunction(String responseClassName, String functionName, List<NamedTypeName> indexedParameters,
		...
		MethodSpec.Builder observableMethodBuilder = MethodSpec.methodBuilder(generatedFunctionName).addModifiers(Modifier.PUBLIC)
				.addParameter(BubbleFilter.class, FILTER).returns(parameterizedTypeName);
		...
		observableMethodBuilder.addStatement("return web3j.bubbleLogObservable(filter).map($L)", converter);
	...
	MethodSpec buildDefaultEventObservableFunction(String responseClassName, String functionName) {
		...
		observableMethodBuilder.addStatement("$1T filter = new $1T($2L, $3L, " + "getContractAddress())", BubbleFilter.class, START_BLOCK, END_BLOCK)
	...
	public static String getParameterizedType(ParameterizedTypeName parameterizedTypeName) {
		...
		return "\nnew com.bubble.rlp.wasm.ParameterizedTypeImpl(\nnew java.lang.reflect.Type[] {" + argsType + "}, \n" + rawType + ".class" + ", \n"
				+ rawType + ".class)";
	}
