...
public class SolidityFunctionWrapperGeneratorTest extends TempFileProvider {
    ...
    public void testGetFileNoExtension() {
        assertThat(com.bubble.codegen.FunctionWrapperGenerator.getFileNameNoExtension(""), is(""));
        assertThat(com.bubble.codegen.FunctionWrapperGenerator.getFileNameNoExtension("file"), is("file"));
        assertThat(com.bubble.codegen.FunctionWrapperGenerator.getFileNameNoExtension("file."), is("file"));
        assertThat(com.bubble.codegen.FunctionWrapperGenerator.getFileNameNoExtension("file.txt"), is("file"));
    }
    ...
    private void testCodeGenerationJvmTypes(
        ...
        testCodeGeneration(
                contractName, inputFileName, "org.web3j.unittests.java", com.bubble.codegen.FunctionWrapperGenerator.JAVA_TYPES_ARG);
    ...
    private void testCodeGenerationSolidityTypes(
        ...
        testCodeGeneration(
                contractName, inputFileName, "org.web3j.unittests.solidity", com.bubble.codegen.FunctionWrapperGenerator.SOLIDITY_TYPES_ARG);
    }
    ...
    private void testCodeGeneration(
        ...
        com.bubble.codegen.SolidityFunctionWrapperGenerator.main(Arrays.asList(
                types,
