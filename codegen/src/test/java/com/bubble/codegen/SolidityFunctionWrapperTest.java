...
import com.bubble.abi.solidity.datatypes.generated.*;
import com.bubble.protocol.core.methods.response.AbiDefinition;
...
import static com.bubble.codegen.SolidityFunctionWrapper.*;
...
public class SolidityFunctionWrapperTest extends TempFileProvider {
    ...
    public void testBuildFunctionTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public com.bubble.protocol.core.RemoteCall<com.bubble.protocol.core.methods.response.TransactionReceipt> functionName(java.math.BigInteger param) {\n"
                        + "  final com.bubble.abi.solidity.datatypes.Function function = new com.bubble.abi.solidity.datatypes.Function(\n"
                        + "      FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<com.bubble.abi.solidity.datatypes.Type>asList(new com.bubble.abi.solidity.datatypes.generated.Uint8(param)), \n"
                        + "      java.util.Collections.<com.bubble.abi.solidity.TypeReference<?>>emptyList());\n"
    ...
    public void testBuildPayableFunctionTransaction() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public com.bubble.protocol.core.RemoteCall<com.bubble.protocol.core.methods.response.TransactionReceipt> functionName(java.math.BigInteger param, java.math.BigInteger vonValue) {\n"
                        + "  final com.bubble.abi.solidity.datatypes.Function function = new com.bubble.abi.solidity.datatypes.Function(\n"
                        + "      FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<com.bubble.abi.solidity.datatypes.Type>asList(new com.bubble.abi.solidity.datatypes.generated.Uint8(param)), \n"
                        + "      java.util.Collections.<com.bubble.abi.solidity.TypeReference<?>>emptyList());\n"
    ...
    public void testBuildFunctionConstantSingleValueReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public com.bubble.protocol.core.RemoteCall<java.math.BigInteger> functionName(java.math.BigInteger param) {\n"
                        + "  final com.bubble.abi.solidity.datatypes.Function function = new com.bubble.abi.solidity.datatypes.Function(FUNC_FUNCTIONNAME, \n"
                        + "      java.util.Arrays.<com.bubble.abi.solidity.datatypes.Type>asList(new com.bubble.abi.solidity.datatypes.generated.Uint8(param)), \n"
                        + "      java.util.Arrays.<com.bubble.abi.solidity.TypeReference<?>>asList(new com.bubble.abi.solidity.TypeReference<com.bubble.abi.solidity.datatypes.generated.Int8>() {}));\n"
    ...
    public void testBuildFunctionConstantSingleValueRawListReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected =
                "public com.bubble.protocol.core.RemoteCall<java.util.List> functionName(java.math.BigInteger param) {\n"
                + "  final com.bubble.abi.solidity.datatypes.Function function = new com.bubble.abi.solidity.datatypes.Function(FUNC_FUNCTIONNAME, \n"
                + "      java.util.Arrays.<com.bubble.abi.solidity.datatypes.Type>asList(new com.bubble.abi.solidity.datatypes.generated.Uint8(param)), \n"
                + "      java.util.Arrays.<com.bubble.abi.solidity.TypeReference<?>>asList(new com.bubble.abi.solidity.TypeReference<com.bubble.abi.solidity.datatypes.DynamicArray<com.bubble.abi.solidity.datatypes.Address>>() {}));\n"
                + "  return new com.bubble.protocol.core.RemoteCall<java.util.List>(\n"
                + "      new java.util.concurrent.Callable<java.util.List>() {\n"
                + "        @java.lang.Override\n"
                + "        @java.lang.SuppressWarnings(\"unchecked\")\n"
                + "        public java.util.List call() throws java.lang.Exception {\n"
                + "          java.util.List<com.bubble.abi.solidity.datatypes.Type> result = (java.util.List<com.bubble.abi.solidity.datatypes.Type>) executeCallSingleValueReturn(function, java.util.List.class);\n"
    ...
    public void testBuildFunctionConstantMultipleValueReturn() throws Exception {
        ...
        //CHECKSTYLE:OFF
        String expected = "public com.bubble.protocol.core.RemoteCall<com.bubble.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>> functionName(java.math.BigInteger param1, java.math.BigInteger param2) {\n"
                + "  final com.bubble.abi.solidity.datatypes.Function function = new com.bubble.abi.solidity.datatypes.Function(FUNC_FUNCTIONNAME, \n"
                + "      java.util.Arrays.<com.bubble.abi.solidity.datatypes.Type>asList(new com.bubble.abi.solidity.datatypes.generated.Uint8(param1), \n"
                + "      new com.bubble.abi.solidity.datatypes.generated.Uint32(param2)), \n"
                + "      java.util.Arrays.<com.bubble.abi.solidity.TypeReference<?>>asList(new com.bubble.abi.solidity.TypeReference<com.bubble.abi.solidity.datatypes.generated.Int8>() {}, new com.bubble.abi.solidity.TypeReference<com.bubble.abi.solidity.datatypes.generated.Int32>() {}));\n"
                + "  return new com.bubble.protocol.core.RemoteCall<com.bubble.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>>(\n"
                + "      new java.util.concurrent.Callable<com.bubble.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>>() {\n"
                + "        @java.lang.Override\n"
                + "        public com.bubble.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger> call() throws java.lang.Exception {\n"
                + "          java.util.List<com.bubble.abi.solidity.datatypes.Type> results = executeCallMultipleValueReturn(function);\n"
                + "          return new com.bubble.tuples.generated.Tuple2<java.math.BigInteger, java.math.BigInteger>(\n"
    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        String expected =
                "class testClass {\n"
                        + "  public static final com.bubble.abi.solidity.datatypes.Event TRANSFER_EVENT = new com.bubble.abi.solidity.datatypes.Event(\"Transfer\", \n"
                        + "      java.util.Arrays.<com.bubble.abi.solidity.TypeReference<?>>asList(new com.bubble.abi.solidity.TypeReference<com.bubble.abi.solidity.datatypes.Utf8String>(true) {}, new com.bubble.abi.solidity.TypeReference<com.bubble.abi.solidity.datatypes.Address>(true) {}, new com.bubble.abi.solidity.TypeReference<com.bubble.abi.solidity.datatypes.Address>(true) {}, new com.bubble.abi.solidity.TypeReference<com.bubble.abi.solidity.datatypes.generated.Uint256>() {}, new com.bubble.abi.solidity.TypeReference<com.bubble.abi.solidity.datatypes.Utf8String>() {}));\n  ;\n\n"
                        + "  public java.util.List<TransferEventResponse> getTransferEvents(com.bubble.protocol.core.methods.response.TransactionReceipt transactionReceipt) {\n"
                        + "    java.util.List<com.bubble.tx.Contract.EventValuesWithLog> valueList = extractEventParametersWithLog(TRANSFER_EVENT, transactionReceipt);\n"
                        + "    java.util.ArrayList<TransferEventResponse> responses = new java.util.ArrayList<TransferEventResponse>(valueList.size());\n"
                        + "    for (com.bubble.tx.Contract.EventValuesWithLog eventValues : valueList) {\n"
                        ...
                        "(com.bubble.protocol.core.methods.request.BubbleFilter filter) {\n"
                        + "    return web3j.bubbleLogObservable(filter).map(new rx.functions.Func1<com.bubble.protocol.core.methods.response.Log, TransferEventResponse>() {\n"
                        + "      @java.lang.Override\n"
                        + "      public TransferEventResponse call(com.bubble.protocol.core.methods.response.Log log) {\n"
                        + "        com.bubble.tx.Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(TRANSFER_EVENT, log);\n"
                        + "        TransferEventResponse typedResponse = new TransferEventResponse();\n"
                        ...
                        + "  }\n"
                        + "\n"
                        + "  public rx.Observable<TransferEventResponse> transferEventObservable(com.bubble.protocol.core.DefaultBlockParameter startBlock, com.bubble.protocol.core.DefaultBlockParameter endBlock) {\n"
                        + "    com.bubble.protocol.core.methods.request.BubbleFilter filter = new com.bubble.protocol.core.methods.request.BubbleFilter(startBlock, endBlock, getContractAddress());\n"
                        + "    filter.addSingleTopic(com.bubble.abi.solidity.EventEncoder.encode(TRANSFER_EVENT));\n"
                        + "    return transferEventObservable(filter);\n"
                        + "  }\n"
                        + "\n"
                        + "  public static class TransferEventResponse {\n"
                        + "    public com.bubble.protocol.core.methods.response.Log log;\n"
                        + "\n"
                        + "    public byte[] id;\n"
                        + "\n"
