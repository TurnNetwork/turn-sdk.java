...
public class ContractJsonParseTest {
    ...
    static com.bubble.codegen.TruffleJsonFunctionWrapperGenerator.Contract parseContractJson(String baseDir,
                                                                                             String contractName, String inputFileName)
            throws Exception {

        String fileLocation = jsonFileLocation(baseDir, contractName, inputFileName);
        return com.bubble.codegen.TruffleJsonFunctionWrapperGenerator.loadContractDefinition(new File(fileLocation));
    }
    ...
    public void testParseMetaCoin() throws Exception {
        com.bubble.codegen.TruffleJsonFunctionWrapperGenerator.Contract mc = parseContractJson(contractBaseDir, "MetaCoin", "MetaCoin");
    ...
    public void testParseConvertLib() throws Exception {
        com.bubble.codegen.TruffleJsonFunctionWrapperGenerator.Contract mc = parseContractJson(contractBaseDir, "MetaCoin", "ConvertLib");
